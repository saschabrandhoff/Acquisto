...
(
    ...
    (
        ...
        (
            array('tl_shop_warengruppen', 'addBreadcrumb'),
            array('tl_shop_warengruppen', 'setDefaultLanguage')
        ),
        'onsubmit_callback' => array
        (
            array('tl_shop_warengruppen', 'updateSitemap'),
        )
    ),
...
<ul id="tl_breadcrumb">
  <li>' . implode(' &gt; </li><li>', $arrLinks) . '</li>
    ...
    public function addIcon($row, $label, DataContainer $dc=null, $imageAttribute='', $blnReturnImage=false)
    {
        ...
        $image = '/system/modules/acquistoShop/html/categorieTree/' . $image;
