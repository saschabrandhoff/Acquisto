...
class mod_acquistoShop_Bestelldetails extends Module
{
    ...
    protected function compile()
    {
        ...
        if (FE_USER_LOGGED_IN) {
            ...
            $objKunde        = $this->Database->prepare("SELECT * FROM tl_shop_orders_customers WHERE pid = ?")->limit(1)->execute($objBestellungen->id);
...
//            $objBestellungen->endpreis = $objPositionen->endpreis + $objBestellungen->versandpreis;
            ...
            $this->Template->Kunde        = (object) $objKunde->row();
