 ...
 *
 * $Date: 2011-07-14 14:27:46 +0200 (Thu, 14 Jul 2011) $
 * @version SofortLib 1.3.0  $Id: sofortLib_multipay.inc.php 1182 2011-07-14 12:27:46Z dehn $
...
class SofortLib_Multipay extends SofortLib_Abstract
{
	 ...
	 */
	function SofortLib_Multipay($apikey='', $apiUrl = 'https://api.sofort.com/api/xml/') {
	...
	function setSofortueberweisungCustomerprotection($customerProtection = true) {
		...
		$this->parameters['su']['customer_protection'] = $customerProtection;
		return $this;
	}
	...
	function setSofortvorkasseCustomerprotection($customerProtection = true) {
		...
		$this->parameters['sv']['customer_protection'] = $customerProtection;
		return $this;
	}
