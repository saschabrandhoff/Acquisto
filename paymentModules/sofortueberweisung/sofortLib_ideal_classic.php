 ...
 *
 * $Date: 2011-07-12 15:44:49 +0200 (Tue, 12 Jul 2011) $
 * @version SofortLib 1.3.0  $Id: sofortLib_ideal_classic.php 1162 2011-07-12 13:44:49Z dehn $
...
class SofortLib_iDealClassic extends SofortLib_SofortueberweisungClassic
{
	...
	var $apiUrl = 'https://www.sofort.com/payment/ideal';
	var $apiKey = '';
	 ...
	 */
	function SofortLib_iDealClassic($configurationKey, $password, $hashfunction = 'sha1' , $apiUrl = 'https://www.sofort.com/payment/ideal') {
		
		$this->apiUrl = $apiUrl;
		list($userid, $projectid, $apiKey) = explode(':', $configurationKey);
		$this->sofortLib = new SofortLib_iDeal_Banks($configurationKey, $apiUrl);
