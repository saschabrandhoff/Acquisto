<div class="<?php echo $this->class; ?>"<?php echo $this->cssID; ?><?php if ($this->style): ?> style="<?php echo $this->style; ?>"<?php endif; ?>>
    ...
    <?php if ($this->Produkt->varianten): ?>
        <div class="attributes">
            <form method="post" name="formAttributes">
            <?php foreach($this->Produkt->varianten as $Attribut):?>
            <p>
            <label for="attribute_<?php echo $Attribut->id; ?>"><?php echo $Attribut->bezeichnung; ?></label>
            <select name="attribute_<?php echo $Attribut->id; ?>">
                <?php foreach($Attribut->varianten as $Variante): ?>
                <option value=""><?php echo $Variante->bezeichnung; ?></option>
                <?php endforeach; ?>
            </select>
            </p>
            <?php endforeach; ?>
